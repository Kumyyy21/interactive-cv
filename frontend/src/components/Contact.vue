...
<template>
  <footer id="kontak" class="py-20 bg-gray-800 text-white">
    <div class="container mx-auto px-6 text-center">
      ...
      <a href="mailto:emailanda@example.com" class="bg-blue-600 text-white font-bold py-3 px-6 rounded-lg hover:bg-blue-700 transition-colors duration-300 inline-block mb-12">
        Kirim Email
      </a>
      ...
      <p class="text-gray-500">© {{ new Date().getFullYear() }} Nama Mahasiswa. Dibuat dengan ♥</p>
    </div>
  </footer>
</template>
